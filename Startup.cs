...
namespace Drinks_Machine_Program
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<ItemStock>();

            services.AddSingleton<CoinStock>();

            services.AddScoped<VendingMachineModel, DrinksMachineModel>();

            services.AddScoped<OrderModel>();

            services.AddScoped<DrinksMachineForm>();
        }
